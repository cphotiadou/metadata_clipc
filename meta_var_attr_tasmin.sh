...
#
#==========================================================================================================================================
# correct variable attributes for tasmin indices
#==========================================================================================================================================
#
...
ind=('FD' 'TR' 'TN')
indices=('fd' 'tr' 'tn')
invar_vari='tasminAdjust' #'pr' #'tasmaxAdjust' 'prAdjust' 'tasAdjust' #tas(nobc)
...
for k in {0..2}; do #indices
	...
	for j in {0..9}; do  #gcms
		...
		for i in {0..2}; do #exper
            ...
            ncatted -O -a invar_bc_observation_id,global,o,c,EOBSv10 -h ${dir_in}${indices[k]}_${path_ic_inst}_${gcms[j]}_${exper[i]}_${path_real_bc}_${time_cov_start[i]}-${time_cov_end[i]}.nc
